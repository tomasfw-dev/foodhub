...
router.post('/', uploadPromocionImagen, verifyCsrf, handleUploadError, promocionesController.store);
router.get('/:id/edit', promocionesController.editPage);
router.post('/:id/edit', uploadPromocionImagen, verifyCsrf, handleUploadError, promocionesController.update);
